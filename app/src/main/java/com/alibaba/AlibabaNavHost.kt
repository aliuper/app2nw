...
import com.alibaba.feature.panelcheck.PanelCheckRoute
...
private object Routes {
    ...
    const val PANELCHECK = "panelcheck"
}
    ...
    NavHost(
        ...
        composable(Routes.HOME) {
            HomeScreen(
                ...
                onPanelCheckClick = { navController.navigate(Routes.PANELCHECK) }
            )
        }
